import argparse
from JSP_AGV.DRL.PPO_discrete.replaybuffer import ReplayBuffer
...
def main(args, env,model_path):
    ...
    while total_steps < args.max_train_steps:
        ...
        # save_model
        if episode_step % 500 == 0 and episode_step > 3000 or episode_step == 5000:
            agent.save_model(model_path, episode_step)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--max_train_steps", type=int, default=5000*n*m, help=" Maximum number of training steps")
    ...
    env = Env(args)
    model_path=r'C:\Users\Aihong\PycharmProjects\Long_Live_Guraduation\JSP_AGV\Experiment\Experiment_result\PPO\model_save'+'4_6_20'
    main(args, env,model_path)
