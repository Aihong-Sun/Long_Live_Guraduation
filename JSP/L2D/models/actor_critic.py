...
from JSP.L2D.models.mlp import MLPActor
from JSP.L2D.models.mlp import MLPCritic
import torch.nn.functional as F
from JSP.L2D.models.graphcnn_congForSJSSP import GraphCNN
import torch
...
class Wang_ActorCritic(nn.Module):
    def __init__(self,
                 n_j,
                 n_m,
                 # feature extraction net unique attributes:
        ...
        super(Wang_ActorCritic, self).__init__()
        # job size for problems, no business with network
        self.n_j = n_j
        # machine size for problems, no business with network
        self.n_m = n_m
