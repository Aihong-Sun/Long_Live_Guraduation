...
parser.add_argument('--np_seed_train', type=int, default=200, help='Seed for numpy for Experiment')
...
# args for PPO
parser.add_argument('--num_envs', type=int, default=4, help='No. of envs for Experiment')
parser.add_argument('--max_updates', type=int, default=20000, help='No. of episodes of each env for Experiment')
