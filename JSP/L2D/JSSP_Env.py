...
# Libing Wang(2021). Dynamic job-shop scheduling in smart manufacturing using deep reinforcement learning,Computer Networks
#DOI: 10.1016/j.comnet.2021.107969
class Wang_SJSSP(gym.Env, EzPickle):
    def __init__(self,
                 n_j,
                 n_m):
        EzPickle.__init__(self)
    ...
    def step(self, action):
        ...
        self.s = np.stack((self.m, self.dur, self.finished_mark))
        ...
        return self.s, fea, reward, self.done(), self.omega, self.mask
    ...
    def reset(self, data):
        ...
        return self.s, fea, self.omega, self.mask
