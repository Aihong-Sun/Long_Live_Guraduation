...
if __name__ == '__main__':
    ...
    # path = r'C:\Users\Administrator\PycharmProjects\Long_live_graduation\JSP\L2D\SavedNetwork/{}.pth'.format(str(N_JOBS_N) + '_' + str(N_MACHINES_N) + '_' + str(LOW) + '_' + str(HIGH))
